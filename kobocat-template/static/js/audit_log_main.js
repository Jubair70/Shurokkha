...
function createTableRow(jsondata){
    ...
    for (i = 0; i < length; i++){
        ...
        var spTableRowData = $('<td class="td-center tg-yw4l" style="width:30px;">'+serial+'</td><td class="tg-yw4l"  align="center" style="width:160px;"><b>'+form_title+'</b><br>('+form_id_string+')</td>'+
        ...
        var spTableRowDiffButton = $('<td class="tg-yw4l" align="center" style="width:90px;">'+
            '<button class="btn red" type="button" onclick="gotoDiff(\''+form_id_string+'\',\''+request_user+'\',\''+instanceID+'\',\''+data_id+'\')">View Diff</button></td>');
