...
class UserForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('username', 'first_name', 'last_name', 'password','email') # ,'is_superuser' 'date_joined',
...
class UserProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('admin','employee_id','country','position', 'username')
...
class OrganizationForm(forms.ModelForm):
    ...
    acc_code = forms.CharField(label='Account Code',required=False)
    branch_code = forms.CharField(label='Branch Code',required=False)
    ...
    class Meta:
        model = Organizations
        fields = ('organization','parent_organization','acc_code', 'branch_code')
