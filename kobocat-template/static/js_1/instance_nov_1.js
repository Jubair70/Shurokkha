...
function createTable(canEdit,datavals) {
    ...
    if (canEdit === true) {
        var editDelete = '<div class="row"><div class="col-md-6" style="margin-left: 21px;"><a target="_self" id="title_edit" href="#kate" class="btn red bind-edit disabled">' + gettext("edit") + '</a>&nbsp;<a href="#"class="btn red btn-danger">' + gettext("Delete") + '</a>&nbsp;<a onclick="printMe();" class="btn">Print</a></div></div><div class="top-buffer-min">';
