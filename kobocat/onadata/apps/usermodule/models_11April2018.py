...
class Organizations(models.Model):
    ...
    acc_code = models.CharField(max_length=150)
...
class ProfileOrganization(models.Model):
    profile = models.ForeignKey('UserModuleProfile', on_delete=models.CASCADE)
    organization= models.ForeignKey('Organizations',blank=True, null=True, on_delete=models.PROTECT)
