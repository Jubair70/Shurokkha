...
urlpatterns = patterns('',
    ...
    url(r"^(?P<username>\w+)/get/user_villagelist/$", views.get_village_list, name='get_village_list'),
    url(r"^(?P<username>\w+)/get/user_inputlist/$", views.get_input_list, name='get_input_list'),
    url(r"^(?P<username>\w+)/get/user_assetlist/$", views.get_asset_list, name='get_asset_list'),
    url(r"^(?P<username>\w+)/get/user_pralist/$", views.get_pra_list, name='get_pra_list'),
    url(r"^(?P<username>\w+)/get/user_volist/$", views.get_vo_list, name='get_vo_list'),
    url(r"^(?P<username>\w+)/get/user_userlist/$", views.get_user_list, name='get_user_list'),
    url(r"^(?P<username>\w+)/get/user_traininglist/$", views.get_training_list, name='get_training_list'),
    ...
    url(r'^po_csv/(?P<username>[^/]+)/$', views.create_po_csv, name='create_po_csv'),
    )
